...
export const workoutSignalSnapshots: WorkoutSignalSnapshot[] = [
  {
    id: "signals-1",
    label: "Controlled progression run",
    date: "2026-04-04",
    athleteWeightKg: 74.8,
    averagePowerWatts: 314,
    averageHeartRateBpm: 156,
    speedMetersPerSecond: 4.58,
    averageCadenceSpm: 178,
    firstHalfHeartRateBpm: 152,
    secondHalfHeartRateBpm: 157,
    vo2Max: 58.9,
    heartRateDrop1Min: 33,
    heartRateDrop2Min: 48,
    elevationGainMeters: 88,
    verticalOscillationCm: 7.5,
    groundContactTimeMs: 235,
    strideLengthMeters: 1.54,
    airTemperatureC: 23,
    dewPointC: 9,
  ...
  {
    id: "signals-2",
    label: "Long run durability check",
    date: "2026-03-23",
    athleteWeightKg: 75.4,
    averagePowerWatts: 298,
    averageHeartRateBpm: 159,
    speedMetersPerSecond: 4.37,
    averageCadenceSpm: 176,
    firstHalfHeartRateBpm: 154,
    secondHalfHeartRateBpm: 162,
    vo2Max: 57.8,
    heartRateDrop1Min: 30,
    heartRateDrop2Min: 43,
    elevationGainMeters: 121,
    verticalOscillationCm: 7.9,
    groundContactTimeMs: 241,
    strideLengthMeters: 1.49,
    airTemperatureC: 19,
    dewPointC: 15,
  ...
  {
    id: "signals-3",
    label: "Marathon fade sample",
    date: "2026-01-18",
    athleteWeightKg: 77.1,
    averagePowerWatts: 286,
    averageHeartRateBpm: 168,
    speedMetersPerSecond: 4.18,
    averageCadenceSpm: 174,
    firstHalfHeartRateBpm: 160,
    secondHalfHeartRateBpm: 171,
    vo2Max: 55.6,
    heartRateDrop1Min: 24,
    heartRateDrop2Min: 36,
    elevationGainMeters: 134,
    verticalOscillationCm: 8.3,
    groundContactTimeMs: 252,
    strideLengthMeters: 1.43,
    airTemperatureC: 24,
    dewPointC: 18,
